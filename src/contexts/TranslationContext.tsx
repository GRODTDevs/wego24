...
const translations = {
  en: {
    ...
    // Location Management English
    'locations.title': 'Location Management',
    'locations.addLocation': 'Add Location',
    'locations.editLocation': 'Edit Location',
    'locations.addNewLocation': 'Add New Location',
    'locations.businessName': 'Business Name',
    'locations.contactEmail': 'Contact Email',
    'locations.phone': 'Phone',
    'locations.businessType': 'Business Type',
    'locations.selectBusinessType': 'Select business type',
    ...
    'locations.businessTypes.grocery': 'Grocery Store',
    'locations.businessTypes.pharmacy': 'Pharmacy',
    'locations.businessTypes.retail': 'Retail Store',
    ...
    'locations.featuredImage': 'Featured Image',
    'locations.bannerImage': 'Banner Image',
    'locations.deliveryFee': 'Delivery Fee (€)',
    'locations.minimumOrder': 'Minimum Order (€)',
    'locations.minDeliveryTime': 'Min Delivery Time (min)',
    'locations.maxDeliveryTime': 'Max Delivery Time (min)',
    'locations.deliveryAvailable': 'Delivery Available',
    'locations.pickupAvailable': 'Pickup Available',
    ...
    'locations.noLocationsDesc': 'Start by adding your first business location.',
    'locations.addFirstLocation': 'Add First Location',
    'locations.deleteConfirm': 'Are you sure you want to delete this location?',
    'locations.loading': 'Loading...',
    'locations.required': '*',
    'locations.success.locationCreated': 'Location and owner account created successfully',
    'locations.success.locationUpdated': 'Location updated successfully',
    'locations.success.locationDeleted': 'Location deleted successfully',
    'locations.success.imageUploaded': 'image uploaded successfully',
    'locations.errors.failedToLoad': 'Failed to load locations',
    'locations.errors.failedToSave': 'Failed to save location',
    'locations.errors.failedToDelete': 'Failed to delete location',
    'locations.errors.failedToUpload': 'Failed to upload image',
